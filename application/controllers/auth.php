...
class Auth extends CI_Controller {
	...
	function index()
	{
		...
		else
		{
			...
			//$this->template->load('templates/template_admin', 'auth/index', $this->data);
	...
	function login()
	{
		...
		{  //the user is not logging in so display the login page
			...
			$this->template->set('headline', '<h2>'.$ssname.' - Login</h2>');
			//$this->load->view('auth/login', $this->data);
			$this->template->set('title', 'Login');
			$this->template->set('shownav', false);
			$this->template->load('templates/template_admin', 'auth/login', $this->data);
		}
	}
	...
	function create_user()
	{
		...
		{ //display the create user form
			...
			$this->template->set('shownav', true);
			$this->template->load('templates/template_admin', 'auth/create_user', $this->data);
